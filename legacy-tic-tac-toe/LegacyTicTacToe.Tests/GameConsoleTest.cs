...
public class GameConsoleTest
{
    ...
    public void SetUp()
    {
        ...
        _game = new Game(_inputX, _outputX, _inputO,_outputO
        );
        _outputXCalls = new List<string>();
        _outputOCalls = new List<string>();
        
        _outputX.Display(msg: Arg.Do<string>(useArgument: s => _outputXCalls.Add(s) ));
        _outputO.Display(msg: Arg.Do<string>(useArgument: s => _outputOCalls.Add(s) ));
    }
